...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        if (password_verify($oldPassword, $currentPasswordHash)) {
            ...
            mysqli_stmt_bind_param($updateStmt, 'ss', $newPasswordHash, $username);
...
<body>
    ...
    <div class="options-container">
        <div class="heado"><i class="bi bi-key"></i> Change Password</div>
        ...
        <!-- Change Password Form -->
                ...
                <?php endif; ?>
        <form action="change_pass.php" method="post" class="form-group">
            <div class="mb-3">
                <label for="oldPassword" class="form-label">
                    <i class="bi bi-lock"></i> Old Password
                </label>
